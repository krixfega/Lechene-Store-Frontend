                        ...
                        <div class="row align-items-center position-relative">
                            <div class="col-12 col-sm-6">
                                <div class="hero-slide-content">
                                    <div class="hero-slide-shape-img"><img src="{{asset('shop/images/slider/slider1.png')}}" width="180" height="180" alt="Image"></div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="hero-slide-thumb">
                                    <img src="{{asset('shop/images/slider/slider1.png')}}" width="555" height="550" alt="Image">
                                </div>
                            </div>
                        </div>
                ...
                <div class="swiper-slide hero-slide-item">
                    <div class="container">
                        <div class="row align-items-center position-relative">
                            <div class="col-12 col-sm-6">
                                <div class="hero-slide-content">
                                    <div class="hero-slide-shape-img"><img src="{{asset('shop/images/slider/shape1.png')}}" width="180" height="180" alt="Image"></div>
                                    <h4 class="hero-slide-sub-title">HURRY UP!</h4>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="hero-slide-thumb">
                                    <img src="{{asset('images/slider/slider1-man2.png')}}" width="555" height="550" alt="Image">
                                </div>
                            </div>
                        </div>
                        <div class="hero-social">
            ...
            <div class="swiper banner-slider-container">
                <div class="swiper-wrapper">
                    <a href="shop.html" class="swiper-slide product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/01.png')}}" width="370" height="294" alt="Image-HasTech">
                    </a>
                    <a href="shop.html" class="swiper-slide product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/02.png')}}" width="370" height="294" alt="Image-HasTech">
                    </a>
                    <a href="shop.html" class="swiper-slide product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/03.png')}}" width="370" height="294" alt="Image-HasTech">
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item product-item-border">
                        ...
                        <a class="product-thumb" href="{{ route('product.show',$prod->id) }}">
                            <img src="{{asset('images/products/'.$prod->productImages->first()->name)}}" width="300" height="286" alt="Image-HasTech">
                        </a>
                         @endif
                        ...
                        <div class="product-info">
                            ...
                            <div class="price">&#8358;{{$prod->discounted_price }} <span class="price-old">&#8358;{{ $prod->selling_price }}</span></div>
            ...
            <div class="row mb-n6 mb-sm-n7">
                <div class="col-sm-12 col-md-6 mb-6">
                    ...
                    <a href="shop.html" class="product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/d1.png')}}" width="570" height="266" alt="Image-HasTech">
                    </a>
                ...
                <div class="col-sm-12 col-md-6 mb-6">
                    <!--== Start Product Banner Item ==-->
                    <a href="shop.html" class="product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/d2.png')}}" width="570" height="266" alt="Image-HasTech">
                    </a>
                    <!--== End Product Banner Item ==-->
                </div>
            </div>
                ...
                <div class="col-sm-6 col-lg-4 mb-6">
                    ...
                    <div class="product-item product-item-border">
                        ...
                        <a class="product-thumb" href="shop-single-product.html">
                            <img src="{{asset('images/fibrics/'.$prod->FibricImages->first()->name)}}" width="300" height="286" alt="Image-HasTech">
                        </a>
                        @endif
                        ...
                        <div class="product-info">
                            <h4 class="title"><a href="shop-single-product.html">{{ $prod->name }}</a></h4>
                            <div class="price">&#8358;{{ $prod->selling_price }} <span class="price-old"></span></div>
                            <button type="button" class="info-btn-wishlist" data-bs-toggle="modal" data-bs-target="#action-WishlistModal">
                                <i class="fa fa-shopping-cart"></i>
                            </button>
                        </div>
        ...
        <div class="container">
            <div class="row mb-n6">
                <div class="col-sm-6 col-md-3 mb-6">
                    <!--== Start Product Banner Item ==-->
                    <a href="shop.html" class="product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/c1.jpg')}}" width="270" height="419" alt="Image-HasTech">
                    </a>
                    <!--== End Product Banner Item ==-->
                </div>
                <div class="col-sm-6 col-md-3 mb-6">
                    <!--== Start Product Banner Item ==-->
                    <a href="shop.html" class="product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/c2.jpg')}}" width="270" height="419" alt="Image-HasTech">
                    </a>
                    <!--== End Product Banner Item ==-->
                </div>
                <div class="col-sm-6 col-md-3 mb-6">
                    <!--== Start Product Banner Item ==-->
                    <a href="shop.html" class="product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/c3.png')}}" width="270" height="419" alt="Image-HasTech">
                    </a>
                    <!--== End Product Banner Item ==-->
                </div>
                <div class="col-sm-6 col-md-3 mb-6">
                    <!--== Start Product Banner Item ==-->
                    <a href="shop.html" class="product-banner-item">
                        <img class="icon" src="{{asset('shop/images/shop/banner/c4.jpg')}}" width="270" height="419" alt="Image-HasTech">
                    </a>
                    <!--== End Product Banner Item ==-->
                </div>
            </div>
