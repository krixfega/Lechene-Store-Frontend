                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex flex-row justify-content-between align-items-center pb-0">
                            ...
                            <div class="p-1">
                                <a href="{{route('booking.index')}}" class="btn btn-link bg-primary text-white  text-center">
                                    <h6 class="text-white text-center">Bookings</h6>
                                </a>
                            </div>
                        </div>
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive  p-0">
                                ...
                                @if(Auth::user()->role == 'Admin')
                                    ...
                                    <tbody>
                                        @forelse ($booking_history as $book)
                                            <tr>
                                            <td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{route('booking.show',$book->id)}}" class="text-success font-weight-bold text-xs"
