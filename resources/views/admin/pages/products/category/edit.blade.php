                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex flex-row justify-content-between align-items-center pb-0">
                            ...
                            <div class="p-1">
                                <a href="{{ route('productsCategory.index') }}"
                                    ...
                                    <h6 class="text-white text-center">All Category</h6>
                                </a>
                            </div>
                        </div>
                        <div class="card-body px-2 pt-2 pb-2">
                            ...
                            @endif
                            <form method="POST" action="{{ route('productsCategory.update', $category->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PATCH')
                                ...
                                @if ($category->image)
                                <div class="my-3">
                                <img src="{{ asset('images/categories/'.$category->image) }}" alt="Category Image" width="150">
