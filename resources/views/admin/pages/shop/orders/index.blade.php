                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header d-flex flex-row justify-content-between align-items-center pb-0">
                            ...
                            <div class="p-1">
                                <a href="{{route('shop.index')}}" class="btn btn-link bg-primary text-white  text-center">
                                ...
                                <table class="table w-full align-items-center mb-0" id="example4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0 {{$order->status == 'pending' ? 'text-warning' :  ($order->status == 'approved' ? 'text-success' : 'text-danger') }}">
                                                {{$order->status}}
                                                </p>
                                                {{-- <p class="text-xs text-secondary mb-0 text-secondary">Organization</p> --}}
                                            </td>
                                            ...
                                            <td class="align-middle">
                                                <a href="{{route('orders.view',$order->id)}}" class="text-success font-weight-bold text-xs"
