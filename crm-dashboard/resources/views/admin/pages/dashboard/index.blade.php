                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-9">
                                    <div class="numbers">
                                        <p class="text-xs mb-0 text-uppercase font-weight-bold">Daily income</p>
                    ...
                    <div class="card bg-secondary">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-9">
                                    <div class="numbers ">
                                        <p class="text-xs mb-0 text-danger text-uppercase font-weight-bold">in Progress</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $pending_orders }}
                                        </h5>
                    ...
                    <div class="card bg-secondary">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-9">
                                    <div class="numbers ">
                                        <p class="text-xs mb-0 text-success text-uppercase font-weight-bold">Approved</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $approved_orders }}
                                        </h5>
                                        <p class="mb-0 text-white text-sm">
                            ...
                            <div class="row">
                                <div class="col-9">
                                    <div class="numbers text-white">
                                        <p class="text-xs mb-0 text-uppercase font-weight-bold">Total Customers</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $total_customers }}
                                        </h5>
                                        <p class="mb-0 text-sm">
                    ...
                    <div class="card bg-secondary">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-9">
                                    <div class="numbers ">
                                        <p class="text-xs mb-0 text-danger text-uppercase font-weight-bold">Booking in
                                            Progress</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $pending_booking }}
                                        </h5>
                    ...
                    <div class="card bg-secondary">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-9">
                                    <div class="numbers ">
                                        <p class="text-sm mb-0 text-success text-uppercase font-weight-bold">Booking
                                            Approved</p>
                                        <h5 class="font-weight-bolder">
                                            {{ $approved_booking }}
                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0"> &#8358;
                                                        {{ $prod->products->selling_price * $prod->total_quantity }}</h6>
                                                </div>
                                            </td>
                                            <td class="align-middle text-sm">
                                                <div class="col text-center">
                                                    ...
                                                    <h6 class="text-sm mb-0">
                                                        {{ round((($prod->products->selling_price - $prod->products->cost_price) / $prod->products->cost_price) * 100, 2) }}
                                                        %</h6>
                                                </div>
                                            </td>
                                        </tr>
