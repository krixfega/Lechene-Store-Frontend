    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        var props = {
            ...
            template: // the template of the input
                ...
                // '<button style="" class="btn btn-decrement ${buttonsClass} btn-minus" type="button">${decrementButton}</button>' +
                // '<input type="text" inputmode="decimal" style="text-align: ${textAlign}" class=""/>' +
                // '<button style="" class="btn btn-increment ${buttonsClass} btn-plus" type="button">${incrementButton}</button>' +
                // '</div>'


  '<div class="d-flex">'+
   ' <div class="flex-column">'+
'<button type="button" style="" class="btn  btn-sm btn-decrement ${buttonsClass} btn-minus" type="button" >${decrementButton}</button>'+
   ' </div>'+
    '<div class="flex-column">'+
    '<input type="text" inputmode="decimal" style="text-align: ${textAlign}" class="form-control"/>' +
    '</div>'+
    '<div class="flex-column">'+
'<button type="button" style="" class="btn btn-sm btn-increment ${buttonsClass} my-4 my-lg-0 btn-plus" type="button" >${incrementButton}</button>'+
 ...
 ' </div>'
        ...
        this.each(function () {
            ...
            function updateAttributes() {
                ...
                $inputGroup.prop("class", "d-sm-flex " + groupClass + " " + props.groupClass)
